...
def preprocess_historical_price_full(
    ...
    historical_price_full["date"] = pd.to_datetime(
...
def betas_table_model_input(
    ...
    preprocessed_historical_price_full["date"] = pd.to_datetime(
        preprocessed_historical_price_full["date"], utc=True
    )
    preprocessed_etf_prices["date"] = pd.to_datetime(
        preprocessed_etf_prices["date"], utc=True
    )
    preprocessed_fred_data["date"] = pd.to_datetime(
        preprocessed_fred_data["date"], utc=True
    )
